...
class Dame(FigurBuilder):
    '''
    Vor.: -image- ist vom Typ String, welcher den Pfad der Textur beschreibt, die die Dame besitzt. Die Textur ist dort im PNG Format gespeichert.
          -size- ist vom Typ Integer und beschreibt wie viele Pixel gross die Dame dargestellt werden soll. Die Textur wird immer Quadratisch geladen.
    ...
    Eff.: -
    Erg.: Eine Dameninstanz ist geliefert, welche -FigurBuilder- geerbt hat.
    '''
...
if __name__ == "__main__":
    ...
    TestDame = Dame("assets/graphics/s_turm.png", 80, 400, 1, "a", 0, False)
