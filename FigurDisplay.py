...
class FigurDisplay(pygame.sprite.Sprite):
    def __init__(self, image:str, size:int, field_length:int, teamID:int, canJump:bool, KillMates:bool=False):
        super().__init__()
    ...
    def getCanKillMates(self):
        return self.__KillMates

    def getNewZugListWithAdd(self, oldZugList:list, RelativePoint:tuple[int, int], onlyOnKill:bool, canKill:bool=True):
        newZug = {}
