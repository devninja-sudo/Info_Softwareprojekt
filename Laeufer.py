...
class Laeufer(FigurBuilder):
    '''
    Vor.: -image- ist vom Typ String, welcher den Pfad der Textur beschreibt, die der Laeufer besitzt. Die Textur ist dort im PNG Format gespeichert.
          -size- ist vom Typ Integer und beschreibt wie viele Pixel gross der Laeufer dargestellt werden soll. Die Textur wird immer Quadratisch geladen.
    ...
    Eff.: -
    Erg.: Eine Lauferinstanz ist geliefert, welche -FigurBuilder- geerbt hat.
    '''
